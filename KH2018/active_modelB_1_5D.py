...
for i in range(start_iter, iterations+1):
	...
	dH_dpm = -apply_grad_y(bracket_2) - 2.0*m_safe + 2.0*rho_safe*p_m

	# δH/δρ
	dH_drho = lap_pr- Pe * m_safe * pr_prime+ Pe * (1.0 - 2.0 * rho_safe) * pm_prime+ (1.0 - 2.0 * rho_safe) * pr_prime**2- 2.0 * m_safe * pr_prime * pm_prime+ p_m**2+pm_prime**2
