...
resume_files = ["checkpoints/checkpoint6.npz", "checkpoints/checkpoint7.npz", "checkpoints/checkpoint8.npz", "checkpoints/checkpoint9.npz"]
...
for i, file in enumerate(resume_files):
    ...
    ### PLOT Hamiltonian
    ax3.set_aspect('auto')
    ax3.plot(np.linspace(0,1,Ncopy), Hamiltonian(h,rho_1d, theta_1d).real*h*aa, label=r"N_x="+str(Ly)+", h="+str(h)+", S="+str("%.6f"%(actionS)), color=colors[i] ) 
